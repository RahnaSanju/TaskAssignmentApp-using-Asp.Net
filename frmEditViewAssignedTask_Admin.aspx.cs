...
{
    public partial class frmEditViewAssignedTask_Admin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SearchQry = "Select distinct a.AssignId,t.TaskName,a.AssignedBy,a.AssignedTo,a.Description,a.duedate,a.Comment,a.Priority,a.Status,a.FileRef from Assign_Tab a join Task_Tab t on a.TaskId=t.TaskId join User_Tab u on a.AssignedTo=u.userid or a.AssignedBy=u.UserID where u.Role in ('Member','Manager')";
                fn_GridviewBind();
            }
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (CheckBoxList1.Items[0].Selected) //assigned by
            {
            ...
            if (CheckBoxList1.Items[1].Selected) //assigned to 
            {
            ...
            if (CheckBoxList1.Items[2].Selected) //due date
            {
                Label2.Visible = true;
                Calendar1.Visible = true;

            }
            if (CheckBoxList1.Items[3].Selected) //task
            {
            ...
            if (CheckBoxList1.Items[4].Selected) //priority
            {
                Label4.Visible = true;
                ddlPriority.Visible = true;

            }
            if (CheckBoxList1.Items[5].Selected) //status
            {
                Label5.Visible = true;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                updQry = "Update Assign_Tab set Priority='" + ddlEditPriority.SelectedItem.Text + "' , DueDate='" + cldEditDuedate.SelectedDate.Date.ToString("yyyy - MM - dd") + "' , Comment='" + txtEditComment.Text + "' , FileRef='" + filePath + "' where AssignId=" + Session["updid"];
            }
            else
            {
                updQry = "Update Assign_Tab set Priority='" + ddlEditPriority.SelectedItem.Text + "' , DueDate='" + cldEditDuedate.SelectedDate.Date.ToString("yyyy - MM - dd") + "' , Comment='" + txtEditComment.Text + "' where AssignId=" + Session["updid"];
            }
