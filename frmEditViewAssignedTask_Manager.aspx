<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEditViewAssignedTask_Manager.aspx.cs" Inherits="TaskAssignmentApp.frmEditViewAssignedTask_Manager" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/frmManagerHomePage.aspx">Go Back to Home Page</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="1131px" AllowPaging="True" CssClass="auto-style10" Height="179px" OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lbUpdate" runat="server" CommandArgument='<%# Eval("AssignId") %>' OnCommand="lbUpdate_Command">Reassign/Update</asp:LinkButton>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlEditTask" runat="server" Width="187px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style7">&nbsp;</td>
            <td>
                <asp:TextBox ID="txtEditDescription" runat="server" Height="101px" TextMode="MultiLine" Width="321px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style9"></td>
        ...
        <tr>
            <td class="auto-style9">
                <asp:Label ID="Label9" runat="server" Text="Assigned To"></asp:Label>
            </td>
            <td class="auto-style7">&nbsp;</td>
            <td>
                <asp:DropDownList ID="ddlEditAssignedTo" runat="server" Height="16px" Width="197px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
